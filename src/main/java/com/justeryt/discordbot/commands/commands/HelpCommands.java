...
public class HelpCommands implements ServerCommand {
    ...
    public void performCommand(String[] arguments, Guild guild, Member member, MessageChannel textChannel, Message message, AudioChannel voiceChannel) {
        EmbedCreate.createEmbedHelp("Вот что я умею","""
                ...
                **♾️!roll, !rollgame, !rollpos** - *!roll <0-100> - рандом в процентаже, !rollgame <value> рандомить слова через пробел, !rollpos - Рандомные позиции в доте
                **☄️!gpt <Запрос>** - *Запросы для ChatGPT*""", "GayBot", textChannel,
                Main.getIcon(), 20 );
    }
}
